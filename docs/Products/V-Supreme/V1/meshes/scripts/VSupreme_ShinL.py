...
Product: VSupreme  |  Component: ShinL
Run: blender --background --python this_script.py

Left shin — armored tube with knee joint housing at top, 2-DOF ankle joint
housing at bottom, shin guard plate, and cable routing.
"""
...
def create_geometry():
    ...
    # Shin guard plate — front armor ridge
