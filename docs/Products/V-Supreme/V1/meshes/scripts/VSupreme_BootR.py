...
Product: VSupreme  |  Component: BootR
Run: blender --background --python this_script.py

Right boot — mirror of BootL. Armored foot shell with ankle coupling,
shock heel, toe cap, treaded sole.
"""
...
def create_geometry():
    ...
    bool_op(toe, toe_cut, 'DIFFERENCE'); bool_op(sole, toe, 'UNION')
    ...
    bool_op(ar, ari, 'DIFFERENCE'); bool_op(sole, ar, 'UNION')
    for i in range(5):
